...
define("jquery.jscrollpane", ["jquery"], function(){});

;(function(window, undefined) {

	$(document).ready(function() {

		// http://stackoverflow.com/a/15801106/625860
...
define("jquery.draggable", ["jquery"], function(){});
...
define("jquery-ui", ["jquery","jquery.mousewheel","jquery.jscrollpane","jquery.draggable"], (function (global) {
    return function () {
        var ret, fn;
        return ret || global.$;
    };
...
define('modules/utils',['editor'],function() {
...
define('modules/menubar',['editor'],function() {
...
define('modules/tools',['editor'],function() {
...
define('modules/canvas',['editor'],function() {
...
//NOTE:POSITION
	Canvas.reposition = function(e) {
		...
		Editor.$("#canvas").css({ top: 100, left: 500 });
	};
...
define('views/tileset_view',['editor'],function() {
...
define('modules/tilesets',["views/tileset_view", "jquery.mousewheel", "jquery.jscrollpane"], function(TilesetView) {
	...
	Tilesets.initialize = function() {
		...
		this.add({
			image: "img/tilesets/growtopia.png",
			tilewidth: 32,
			tileheight: 32
		});
	};
...
define('modules/layers',['editor'],function() {
...
define('modules/import',['editor'],function() {
...
define('modules/export',['editor'],function() {
	...
	Export.process = function() {
		...
		var type = Editor.$("select[name=export_format]").val(),
			include_base64 = Editor.$("select[name=include_base64]").val() == "no",
		...
		anchor.download = filename + "." + type.toLowerCase();
...
define('editor',[
	...
	Editor.initialize = function() {
		...
		$("#loading_screen").delay(4000).fadeOut();
	};
